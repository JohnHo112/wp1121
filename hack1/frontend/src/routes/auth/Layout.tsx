  ...
  const onSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    if (location.pathname === '/login') {
      ...
      if (password !== confirmPassword) {
        // Show a toast notification for password mismatch
        toast({
          description: 'Passwords do not match',
          variant: 'destructive',
        });
        // Return early and do not proceed with registration
        return;
      }
          ...
          <div className="grid w-full items-center space-y-4">
            <div className="flex flex-col gap-2">
              ...
              <Input
                ...
                type="text"
                name="username"
                value={username} // Controlled component: value is set to state variable
            ...
            <div className="flex flex-col gap-2">
              ...
              <Input
                ...
                type="password"
                name="password"
                value={password} // Controlled component: value is set to state variable
